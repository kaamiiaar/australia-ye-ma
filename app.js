...
const listings = [
  ...
  { id: 20, type: 'events', logo: 'ش', fa: 'نمایشگاه سلطنتی ملبورن ۲۰۲۶', en: 'Melbourne Royal Show 2026', placeFa: '۲۴ سپتامبر تا ۴ اکتبر · Melbourne Showgrounds', placeEn: '24 September–4 October · Melbourne Showgrounds', verified: false, sourceName: 'Melbourne Royal', sourceUrl: 'https://royalshow.com.au/', checked: '۳ سپتامبر ۲۰۲۶', descriptionFa: 'نمایش سالانه ملبورن با حیوانات، خوراکی‌ها، سرگرمی و برنامه‌های خانوادگی. زمان‌بندی و بلیت را از برگزارکننده رسمی بررسی کنید.' },
  { id: 21, type: 'events', logo: 'ف', fa: 'فستیوال فرینج ملبورن ۲۰۲۶', en: 'Melbourne Fringe Festival 2026', placeFa: '۲۹ سپتامبر تا ۱۸ اکتبر · نقاط مختلف ملبورن', placeEn: '29 September–18 October · Across Melbourne', verified: false, sourceName: 'Melbourne Fringe', sourceUrl: 'https://www.melbournefringe.com.au/festival-info/festival-faqs', checked: '۳ سپتامبر ۲۰۲۶', descriptionFa: 'فستیوال هنرهای مستقل ملبورن با اجراها و برنامه‌ها در نقاط مختلف شهر. برنامه کامل و دسترسی هر اجرا را در سایت رسمی ببینید.' },
  { id: 22, type: 'events', logo: 'ب', fa: 'بازار شبانه زمستانی', en: 'Winter Night Market', placeFa: 'تا ۹ سپتامبر · Queen Victoria Market', placeEn: 'Until 9 September · Queen Victoria Market', verified: false, sourceName: 'What’s On Melbourne', sourceUrl: 'https://whatson.melbourne.vic.gov.au/things-to-do/whats-on-september', checked: '۳ سپتامبر ۲۰۲۶', descriptionFa: 'بازار شبانه زمستانی با غذا، نوشیدنی و سرگرمی در بازار کویین ویکتوریا. جزئیات روز و ساعت را در صفحه رسمی شهر چک کنید.' },
  { id: 23, type: 'events', logo: 'ن', fa: 'شب‌های جمعه NGV: کارتیه', en: 'NGV Friday Nights: Cartier', placeFa: 'تا ۲ اکتبر، جمعه‌ها ۶ تا ۱۰ شب · NGV', placeEn: 'Until 2 October, Fridays 6–10pm · NGV', verified: false, sourceName: 'NGV', sourceUrl: 'https://www.ngv.vic.gov.au/whats-on/programs-events/', checked: '۳ سپتامبر ۲۰۲۶', descriptionFa: 'برنامه شبانه جمعه‌های گالری ملی ویکتوریا همراه با نمایشگاه کارتیه و اجراهای زنده. این برنامه بلیت‌دار است.' },
  { id: 24, type: 'events', logo: 'ح', fa: 'روز ماجراجویی شکلاتی خانواده', en: 'Chocolate Family Adventure Day', placeFa: 'تا ۲۷ سپتامبر · ملبورن', placeEn: 'Until 27 September · Melbourne', verified: false, sourceName: 'What’s On Melbourne', sourceUrl: 'https://whatson.melbourne.vic.gov.au/things-to-do/whats-on-september', checked: '۳ سپتامبر ۲۰۲۶', descriptionFa: 'یک تجربه خانوادگی شکلات‌محور در ملبورن. تاریخ‌ها، ظرفیت و هزینه را در فهرست رسمی شهر بررسی کنید.' },
...
function listingCard(item) {
  ...
  return `<article class="listing-card" data-listing="${item.id}" tabindex="0" role="button" aria-label="${local(item)}">
    ...
    <div><h3>${local(item)}</h3><p>${place}</p><div class="meta"><span class="${item.prototype ? 'prototype-label' : item.verified ? 'verified' : ''}">${item.prototype ? 'نمونه نمایشی' : item.verified ? '✓ ' + t('verified') : t('unverified')}</span><span>${item.sourceName || t('source')}</span></div></div>
...
function home() {
  ...
  <div class="home-sheet">
    ...
    <section class="section"><div class="section-head"><div><h2><span class="heading-icon">★</span>${t('featured')}</h2></div><button class="text-button" data-category="events">مشاهده همه ‹</button></div><div class="horizontal-list">
      <article class="feature-card event-card" data-listing="20" tabindex="0" role="button"><span class="pill">رویداد</span><div><h3>نمایشگاه سلطنتی ملبورن</h3><p>۲۴ سپتامبر تا ۴ اکتبر · Showgrounds</p></div></article>
      <article class="feature-card sport-card" data-listing="21" tabindex="0" role="button"><span class="pill">هنر</span><div><h3>فستیوال فرینج ملبورن</h3><p>۲۹ سپتامبر تا ۱۸ اکتبر · سراسر شهر</p></div></article>
      <article class="feature-card culture-card" data-listing="23" tabindex="0" role="button"><span class="pill">فرهنگی</span><div><h3>شب‌های جمعه NGV</h3><p>تا ۲ اکتبر · گالری ملی ویکتوریا</p></div></article>
    </div></section>
